...
const Products = () => {
  ...
  return (
    <div className="p-5">
      {/* Header */}
      <div className="flex justify-between items-center mb-5 bg-gray-50 p-4 rounded-lg shadow-sm border border-gray-200">
        <div>
        ...
        <Link to={"/admin/addproducts"}>
          <button className="bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-lg text-white flex items-center shadow-md gap-1 focus:outline-none focus:ring-4 focus:ring-teal-300">
            <IoIosAdd size={24} />
        ...
        {products.map((product) => (
          ...
          >
            ...
            <div className="">
              ...
              <p className="text-gray-600 mt-2 admin-font">{product.price}</p>
